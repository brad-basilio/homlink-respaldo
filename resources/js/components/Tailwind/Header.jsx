        ...
        <>
            ...
            >
                ...
                >
                    ...
                    {WhatsApp && (
                        <div className="flex justify-end w-full mx-auto z-[100] relative px-[5%] lg:px-0 lg:max-w-7xl 2xl:max-w-[85rem] ">
                            <div className="fixed bottom-6 sm:bottom-[2rem] lg:bottom-[4rem] z-20 cursor-pointer">
                                ...
                                >
                                    <img
                                        ...
                                        alt="whatsapp"
                                        className="mr-3 w-16 h-16 md:w-[100px] md:h-[80px]  animate-bounce duration-300"
                                    />
                                </a>
                            </div>
                        </div>
