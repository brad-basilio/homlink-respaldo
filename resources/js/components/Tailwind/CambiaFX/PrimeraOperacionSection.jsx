...
export default function PrimeraOperacionSection() {
    return(  <section className="bg-neutral-dark px-[5%] py-6 md:pt-20 md:pb-10 w-full font-title">
                <div className=" mx-auto px-4">
                    ...
                    <div className="bg-[#C6FF6B] px-16 py-2 rounded-2xl flex flex-col md:flex-row items-center justify-between   relative ">
                        ...
                        <div className="flex-1 flex flex-col justify-center ">
                            <h2 className="text-[32px]  font-semibold leading-[1.1] text-text-neutral-light mb-2">
                                Haz tu primera operación<br />
                                y gana <span className="text-constrast">S/50</span>
                            </h2>
                            <p className="text-base  text-text-neutral-light  font-paragraph">Class aptent taciti sociosqu ad litora torquent per conubia nostra</p>
                        </div>
                        ...
                        <div className=" absolute bottom-0 flex-1 left-1/3 translate-x-1/2 z-50">
                            <img src="/assets/cambiafx/first-operation.webp" alt="Teléfono móvil" className="w-[200px] md:w-[200px] lg:w-[250px] h-auto z-10 relative" />
                        </div>
                        {/* Botón promo */}
                        <div className="flex-1 flex justify-end items-center md:py-12 w-full md:w-auto">
                            <button className="bg-constrast  text-white px-6 py-4 rounded-full font-medium text-sm flex items-center gap-3 transition-all duration-300 shadow-lg">
                                ACTIVAR PROMO
...
<path d="M20.0006 36.6663C10.7958 36.6663 3.33398 29.2043 3.33398 19.9997C3.33398 10.7949 10.7959 3.33301 20.0006 3.33301C27.4634 3.33301 33.7101 8.23782 35.8339 14.9997H31.6673" stroke="#BCFF52" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M20 13.333V19.9997L23.3333 23.333" stroke="#BCFF52" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M36.5918 21.6667C36.6413 21.1182 36.6667 20.5622 36.6667 20M25 36.6667C25.5693 36.4793 26.1255 36.2607 26.6667 36.013M34.651 28.3333C34.9725 27.714 35.2592 27.0722 35.5083 26.4103M30.3208 33.7153C30.8948 33.2402 31.4385 32.7263 31.948 32.1775" stroke="#BCFF52" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                            ...
                            <div className="flex items-center gap-2 mt-2 md:mt-0">
                                <img src="/assets/cambiafx/bcp.png" alt="bcp" className="w-12 h-12 rounded-lg" />
                                <img src="/assets/cambiafx/interbank.png" alt="interbank" className="w-12 h-12 rounded-lg" />
                                <img src="/assets/cambiafx/banbif.png" alt="banbif" className="w-12 h-12 rounded-lg" />
                                <img src="/assets/cambiafx/yape.png" alt="yape" className="w-12 h-12 rounded-lg" />
                                <img src="/assets/cambiafx/plin.png" alt="plin" className="w-12 h-12 rounded-lg" />
                            </div>
                        </div>
                        {/* Derecha */}
                        <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10">
...
<path d="M36.5918 21.6667C36.6413 21.1182 36.6667 20.5622 36.6667 20M25 36.6667C25.5693 36.4793 26.1255 36.2607 26.6667 36.013M34.651 28.3333C34.9725 27.714 35.2592 27.0722 35.5083 26.4103M30.3208 33.7153C30.8948 33.2402 31.4385 32.7263 31.948 32.1775" stroke="#BCFF52" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <div className="flex items-center gap-2 mt-2 md:mt-0">
                                <img src="/assets/cambiafx/azul.png" alt="azul" className="w-12 h-12 rounded-lg" />
                                <img src="/assets/cambiafx/scotiabank.png" alt="scotiabank" className="w-12 h-12 rounded-lg" />
                                <img src="/assets/cambiafx/yellow.png" alt="yellow" className="w-12 h-12 rounded-lg" />
                                <img src="/assets/cambiafx/otros.png" alt="otros" className="w-12 h-12 rounded-lg" />
                            </div>
                        </div>
                    </div>
                    {/* Texto informativo */}
                    <div className="flex justify-end mt-4">
                        <span className="text-white font-medium text-sm">Solo <span className="text-[#C6FF6B] font-semibold">Lima</span>, otros bancos e información bancaria <a href="#" className="text-[#C6FF6B] underline font-semibold">aquí</a></span>
                    </div>
                </div>
            </section>)
}