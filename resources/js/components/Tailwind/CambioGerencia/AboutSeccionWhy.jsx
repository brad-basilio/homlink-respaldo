...
const AboutSeccionWhy = ({ data, beneficios_clave, core_values, banner_why }) => {
  ...
  return (
    ...
    >
      ...
      {/* Beneficios destacados - Versiones separadas para mobile y desktop */}
      <motion.div 
        ...
        >
          ...
          >
            <motion.img 
              ...
              alt={banner_why?.name} 
              className="h-[200px] w-auto lg:h-[500px] object-cover absolute bottom-0 select-none" 
              draggable="false"
            />
          </motion.div>
        ...
        >
          ...
          >
            <motion.img 
              src={`/api/banners/media/${banner_why?.image}`} 
              alt={banner_why?.name} 
              className=" h-[300px] lg:h-[500px] object-cover absolute -left-10 bottom-0 select-none" 
              draggable="false"
          ...
          {/* Columna derecha: mensaje y WhatsApp */}
          <motion.div 
            className="z-10 w-full lg:min-w-max flex flex-col gap-10 items-end pr-8 justify-end md:ml-8 mt-8 md:mt-0"
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, delay: 1.6 }}
            viewport={{ once: true }}
