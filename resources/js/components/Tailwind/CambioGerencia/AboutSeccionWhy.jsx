...
const AboutSeccionWhy = ({ data, beneficios_clave, core_values, banner_why }) => {
  ...
  return (
    <div className="w-full bg-neutral-dark px-[5%] py-20 font-paragraph text-white relative">
      <section className=" flex flex-col lg:flex-row gap-10 items-center">
        ...
        <div className="flex-1 max-w-2xl">
          <div className="flex items-center mb-4">
            ...
            <h3 className="uppercase text-white text-sm font-medium">¿Por qué elegirnos?</h3>
          </div>
          ...
          <p className="text-white text-base mb-6 max-w-xl whitespace-pre-line" dangerouslySetInnerHTML={{ __html: data?.description }}>
              ...
              <div className="flex items-start gap-3">
                <span className="">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8 12.5L10.5 15L16 9" stroke="#BCFF52" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
