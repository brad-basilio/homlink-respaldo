    ...
    return (
        <section className="p-[5%]">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 md:gap-8 items-center">
                ...
                <button
                    className="col-span-1 md:col-span-1 lg:col-span-2 px-6 py-4 text-base uppercase rounded-3xl bg-slate-100 text-slate-900 flex items-center justify-center transition-all"
                    onClick={() =>
                        setFilter((old) => ({
                            ...old,
                ...
                <label
                    htmlFor="txt-search"
                    className="col-span-1 md:col-span-1 lg:col-span-2 px-6 py-4 flex items-center rounded-3xl bg-slate-100"
                >
                ...
                <div className="col-span-1 md:col-span-2 lg:col-span-4 flex flex-wrap gap-3 justify-center lg:justify-start">
                    {categories.map((item, index) => {
                        return (
                            <button
                                key={index}
                                className={`transition-all px-6 py-4 rounded-3xl ${
