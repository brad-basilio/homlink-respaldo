    ...
    return (
        <div className="flex flex-col self-stretch my-auto w-full mt-6">
            ...
            >
                ...
                <div className="flex flex-col w-full">
                    <img
                        ...
                        alt={name}
                        className="w-full object-cover h-40 sm:h-44 md:h-48 rounded-md"
                    />
                </div>
            </div>
            <div className="flex justify-between items-center mt-4 sm:mt-5 md:mt-6 w-full gap-4">
                <a
                    href={`/blog/${id}`}
                    className="flex gap-2 items-center text-sm sm:text-base font-semibold leading-snug text-[#2B384F]"
                >
