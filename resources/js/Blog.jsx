        ...
        <div>
            ...
            <div className="relative  w-full px-16 rounded-[56px] bg-constrast  flex flex-col md:flex-row items-center  py-10 min-h-[380px]">
                ...
                <div className="flex-1 z-10 flex flex-col justify-center items-start gap-2">
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-[64px] font-medium leading-tight text-white mb-2">
                        ¡Tenemos el<br className="hidden md:block" />
                        mejor tipo de<br className="hidden md:block" />
                        <span className="text-secondary font-semibold">cambio para<br className="hidden md:block" />empresas!</span>
                    </h2>
                ...
                <div className="z-10 flex-1 flex justify-center items-end ">
                    <img src="/assets/cambiafx/empresas-person.png" alt="Empresas" className="h-[500px] object-cover absolute bottom-0 select-none" draggable="false" />
                </div>

                {/* Columna derecha: mensaje y WhatsApp */}
                <div className="z-10 flex flex-col gap-10 items-end pr-8 justify-end min-w-[180px] md:ml-8 mt-8 md:mt-0">
                    <div className="text-white relative text-2xl  text-end mb-2">
                        ...
                        <div className="absolute -right-10">
                            <svg width="53" height="76" viewBox="0 0 53 76" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_16_2495)">
                                    <path d="M24.904 2.71705C44.9855 27.8746 39.9591 61.6151 23.9101 73.0194" stroke="#FAF3E1" stroke-width="1.50408" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M25.18 65.8476L23.9083 73.0192L31.0918 71.9369" stroke="#FAF3E1" stroke-width="1.50408" stroke-linecap="round" stroke-linejoin="round" />
                                </g>
                                <defs>
