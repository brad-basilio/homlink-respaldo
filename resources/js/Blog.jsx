            ...
            {postRecent && postRecent.length > 0 ? (
                <>
                    ...
                    <div className="bg-primary">
                        <section className="w-full bg-primary pt-24 pb-10 flex justify-center items-center font-title px-[5%] mx-auto">
                            <div className="relative  w-full px-16 rounded-[56px] bg-constrast  flex flex-col md:flex-row items-center  py-10 max-h-[350px]">
                                {/* Fondo decorativo */}
                        ...
                        <span className="inline-block w-4 h-4 rounded-full border-2 border-white"></span>
                                ...
                                <div className="z-10 flex-1 flex justify-center items-end ">
                                    <img src={`/api/banners/media/${banner?.image}`} alt={banner?.name} className="h-[350px] object-cover absolute bottom-0 select-none" draggable="false" />
                                </div>

                                {/* Columna derecha: mensaje y WhatsApp */}
                                <div className="z-10 flex  gap-10 items-center pr-8 justify-end min-w-[180px] md:ml-8 mt-8 md:mt-0">
