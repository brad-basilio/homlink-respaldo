...
<body class="font-sans bg-gray-100">
  ...
  <!-- Contenido principal -->
  <div class=" flex h-screen w-screen bg-azulmundoweb ">
    ...
    <!-- Columna 2 (50%) -->
      <div class="w-1/2  p-4 text-left h-full flex flex-col justify-center items-center mx-auto">
        <div class="items-center w-4/5 pt-10">
