        ...
        <main>
            <section class="bg_fondoMain bg-cover bg-center bg-no-repeat sm:w-full h-full pt-40 md:pt-32">
                <div class="flex flex-col lg:flex-row justify-between gap-0 md:gap-10">
                    ...
                    <div class="hidden basis-1/2 md:flex items-start justify-end" data-aos="fade-left"
                        data-aos-duration="1500">
                        <img src="{{ asset('images/img/imgMundoWeb/image_website.png') }}" alt="mundo web"
                            class="">
                    </div>
            ...
            <section
                ...
                <div class="w-11/12 mx-auto grid grid-cols-1 lg:grid-cols-2" data-aos="fade-right"
                    data-aos-duration="1500">
                    ...
                    <div id="formulario" class="flex flex-col justify-center gap-10">
                        ...
                        <div class="bg-[#303BE4] px-4 py-5 rounded-2xl">
                                ...
                                <div>
                                    <input type="text" name="contact_name" placeholder="Nombre Completo" required
                                        class="shadow-sm shadow-[#303BE4] border-[#303BE4] border-[1px]
                                          text-[#323BDC] font-montserrat w-full py-2 px-5 rounded-xl text-text16  placeholder-opacity-25 font-medium bg-white">
                                </div>
                                ...
                                <div class="flex flex-col md:flex-row md:justify-between gap-5 w-full">
                                    <div class="w-full">
                                        <input type="email" name="contact_email" placeholder="Correo Electrónico"
                                            required id="email"
                                            class="shadow-sm shadow-[#303BE4] border-[#303BE4] border-[1px]
                                             text-[#323BDC] font-montserrat w-full py-2 px-5 rounded-xl text-text16 font-medium bg-white">
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-col md:flex-row md:justify-between gap-5 w-full">
                                    <div class="w-full flex">
                                        <select id="phone_prefix" name="country_prefix"
                                            ...
                                            w-2/5 text-[#323BDC] font-montserrat py-2 px-5 rounded-l-xl text-text16 font-medium bg-white border-r-0">
                                        ...
                                        <input type="text" name="contact_phone" placeholder="Teléfono" required
                                            ...
                                            class="shadow-sm shadow-[#303BE4] border-[#303BE4] border-[1px] 
                                             text-[#323BDC] font-montserrat w-3/5 py-2 px-5 rounded-r-xl text-text16 font-medium bg-white border-l-0">
                                    </div>
                                </div>
                        ...
                        <div class="swiper proyectos rounded-2xl">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide flex items-center justify-center mx-auto">
                                    <div
                                        class="flex justify-center items-start md:hover:scale-110 md:duration-300 shadow-md shadow-black border-black border-[7px] rounded-xl overflow-hidden">
                                        <img src="{{ asset('images/img/imgMundoWeb/LimpiaBnb.png') }}"
                                            alt="limpiabnb"
                                            class="w-full h-[400px] xl:h-[520px] bg-cover object-cover  object-top"
                                            onclick="openModal('{{ asset('images/img/imgMundoWeb/LimpiaBnb.png') }}')">
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div
                                        class="flex justify-center items-start md:hover:scale-110 md:duration-300 shadow-md shadow-black border-black border-[7px] rounded-xl overflow-hidden">
                                        <img src="{{ asset('images/img/imgMundoWeb/EmprendeEnvio.png') }}"
                                            alt="emprendenvio"
                                            class="w-full h-[400px] xl:h-[520px] bg-cover object-cover  object-top p-0"
                                            onclick="openModal('{{ asset('images/img/imgMundoWeb/EmprendeEnvio.png') }}')">
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div
                                        class="flex justify-center items-start md:hover:scale-110 md:duration-300 shadow-md shadow-black border-black border-[7px] rounded-xl overflow-hidden">
                                        <img src="{{ asset('images/img/imgMundoWeb/PatnertsLogistic.png') }}"
                                            alt="logistic"
                                            class="w-full h-[400px] xl:h-[520px] bg-cover object-cover  object-top p-0"
                                            onclick="openModal('{{ asset('images/img/imgMundoWeb/PatnertsLogistic.png') }}')">
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div
                                        class="flex justify-center items-start md:hover:scale-110 md:duration-300 shadow-md shadow-black border-black border-[7px] rounded-xl overflow-hidden">
                                        <img src="{{ asset('images/img/imgMundoWeb/machineshop.png') }}"
                                            alt="hpi"
                                            class="w-full h-[400px] xl:h-[520px] bg-cover object-cover  object-top p-0"
                                            onclick="openModal('{{ asset('images/img/imgMundoWeb/machineshop.png') }}')">
                                    </div>
                ...
                <div class="w-11/12 bg-white lg:bg-[#303BE4] mx-auto rounded-2xl py-10  px-5 mt-10 mb-20 ">
                            ...
                            <div data-aos="fade-left" data-aos-duration="1500"
                                ...
                                <div class="flex flex-col gap-5 basis-10/12">
                                    <h2 class="font-RightgroteskMedium font-medium text-text32 leading-tight ">8.
                                        Garantía</h2>
                                    <p class="text-text18  font-montserrat font-medium">Luego de entregado el servicio,
                                        contamos con un
                                        periodo de garantía y
                                        acompañamiento para asegurar la calidad de su producto, con mundo web, tendrás
                                        máxima seguridad de
                    ...
                    <div class="w-full relative block lg:hidden procesoRelative" data-aos="fade-left"
                        data-aos-duration="1500">
                                    ...
                                    <div
                                        ...
                                        <div class="flex flex-col gap-5 basis-full">
                                            <h2 class="font-RightgroteskMedium font-medium text-text32 leading-tight ">
                                                8. <br>
                                                Garantía</h2>
                                            <p class="text-text18  font-montserrat font-medium">Luego de entregado el
                                                servicio, contamos con
                                                un periodo de garantía y
                                                acompañamiento para asegurar la calidad de su producto, con mundo web,
                                                tendrás máxima seguridad
