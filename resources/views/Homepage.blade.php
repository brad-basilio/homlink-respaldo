            ...
            <form id="formHome">
              ...
              <div class="grid grid-cols-12 mt-2">
                ...
                <div class="w-full col-span-12 lg:col-span-12  ">
                  <input
                    ...
                    name="contact_name" type="text" placeholder="Nombre completo" id="contact_name">
                  @error('nombre')
              ...
              <div class="grid grid-cols-12 mt-4 gap-3 ">
                ...
                <div class="w-full col-span-12 lg:col-span-6">
                  <input
                    class="font-MontserratRegular appearance-none block w-full bg-inputmw  text-white  border-none rounded-xl py-4 px-3 leading-tight placeholder-slate-300 "
                    name="contact_email" type="email" placeholder="Correo electrónico" id="contact_email">
                  @error('email')
                    <span class="text-red-500 text-base ">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="w-full col-span-12 lg:col-span-6 ">
                  <input
                    class="font-MontserratRegular appearance-none block w-full bg-inputmw  text-white  border-none rounded-xl py-4 px-3 leading-tight placeholder-slate-300 "
                    name="contact_phone" type="text" placeholder="Número de teléfono" id="contact_phone">
                  @error('telefono')
                    <span class="text-red-500 text-base ">{{ $message }}</span>
                  @enderror
                </div>
