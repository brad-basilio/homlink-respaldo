...
<div class=" inset-0 bg-azulanding bg-opacity-75  ">
  ...
  <div class=" grid  grid-cols-12 xs:min-w-96  xs:h-full  ">
      ...
      <div class="xs:col-span-12 lg:col-span-7  flex ">
          ...
          <div class="xs:w-[100%] lg:w-[100%] min-h-96 xs:py-64 xs:hidden lg:block md:h-[100%] fondolanding bg-cover bg-center  object-contain justify-center items-center  ">
               
          </div>
          <div class="xs:w-[100%] lg:w-[100%] md:h-[100%]  xs:py-2 xs:block lg:hidden  justify-center items-center ">
   ...
   <div class="grid grid-cols-12 h-auto text-right items-center justify-between px-[5%] pb-[3%] pt-[1%]">
    ...
    <div  class="xs:col-span-12 lg:col-span-4 ">
        ...
        <div class="group  items-center  justify-end inline-block">   
            ...
            <span class="group-hover:pr-3 transition-all  duration-500 font-MontserratSemibold text-base">Servicio: Aplicativo móvil</span><img src="{{ asset('img/arrowright.svg')}}" alt="Flecha a la derecha" class="h-12 w-12 ml-2 inline-block group-hover:rotate-45 transition-all duration-500"></a>  
        </div>
    
    </div>
   </div>

   {{-- <div class="grid xs:grid-cols-1 lg:grid-cols-4 px-[5%]   py-10  gap-10 text-white  bg-azulanding">
  ...
  <div id="modelConfirm" class="fixed hidden z-50 inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4 ">
    <div class="relative xs:top-8 md:top-10 lg:top-20 mx-auto shadow-xl rounded-md bg-azulform opacity-95 max-w-2xl animate-jump">
        ...
        <div class="p-12 pt-0 text-left">
         <form method="POST" action="{{ route('guardarpopup2') }}">
         @csrf
         ...
         <div class="grid grid-cols-12  mb-2 mt-4">
                 ...
                 <div> 
                  <input class=" font-MontserratRegular appearance-none block w-full bg-fondoinput  text-white  border-none rounded-full py-4 px-4 mb-2 leading-tight "  name="source" type="hidden" value="Landing page">  
                </div>
         </div>
