...
class LandingFormController extends Controller
{
    ...
    public function save(Request $request): HttpResponse|ResponseFactory
    {
        ...
        try {
            ...
            $jpa = LandingForm::find($request->id);
            if (!$jpa) {
                LandingForm::create($body);
            } else {
                $jpa->update($body);
            }
    ...
    static function status(Request $request)
    {
        $response = new Response();
        try {
            LandingForm::where('id', $request->id)
                ->update([
    ...
    static function projectStatus(Request $request)
    {
        $response = new Response();
        try {
            LandingForm::where('id', $request->project)
                ->update([
    ...
    static function delete(Request $request, string $id)
    {
        $response = new Response();
        try {
            $deleted = LandingForm::where('id', $id)
                ->update(['status' => null]);
